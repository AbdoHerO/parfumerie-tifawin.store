...
class BusinessSettingsController extends Controller
{
    ...
    public function updateSheetDB(Request $request)
    {

        $business_settings = BusinessSetting::where('type', 'sheet_db')->first();
        if($business_settings === null){
            $business_settings_new = new BusinessSetting();
            $business_settings_new->type = "sheet_db";
            $business_settings_new->value = $request->api_sheet_db;
            $business_settings_new->save();
        }else{
            $business_settings->value = $request->api_sheet_db;
            $business_settings->save();
        }
