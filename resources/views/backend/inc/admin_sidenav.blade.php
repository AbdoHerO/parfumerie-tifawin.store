        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <!-- @if(Auth::user()->user_type == 'admin')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('ordervisite.index') }}" class="aiz-side-nav-link ">
                                        <span class="aiz-side-nav-text">{{translate('orders_visitors')}}</span>
                                    </a>
                                </li>
                            @endif -->
                        </ul>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-money-bill aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">Event Staffs</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('events.get_events_products') }}" class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Event Products</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('events.get_events_orders') }}" class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Event Orders</span>
                            </a>
                        </li>
                    </ul>
                </li>
