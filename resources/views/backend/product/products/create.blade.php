            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Buying Price')}} <span class="text-danger"></span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="buying_price" placeholder="{{ translate('Buying Price') }}" >
                            </div>
                        </div>
