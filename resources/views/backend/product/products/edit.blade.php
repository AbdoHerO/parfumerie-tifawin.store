            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Buying Price')}} </label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="buying_price" placeholder="{{translate('Buying Price')}}" value="{{ $product->buying_price }}" required>
                            </div>
                        </div>
