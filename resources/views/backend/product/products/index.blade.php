        ...
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="type" id="type" onchange="sort_products()">
                    ...
                    <option value="low_quantity" @isset($col_name) @if($col_name == 'low_quantity') selected @endif @endisset>Quantité faible</option>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <strong>{{translate('buying_price')}}:</strong> {{ single_price($product->buying_price) }} </br>
                        </td>
                        <td>
                            @php
                                $qty = 0;
