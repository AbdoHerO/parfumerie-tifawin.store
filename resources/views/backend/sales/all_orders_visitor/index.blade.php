...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="col-lg-2">
                <div class="form-group mb-0">
                    <input type="text" class="aiz-date-range form-control" disabled value="{{ $date }}" name="date" placeholder="{{ translate('Filter by date') }}" data-format="DD-MM-Y" data-separator=" to " data-advanced-range="true" autocomplete="off">
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group mb-0">
            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="md">Last Name</th>
                        <th data-breakpoints="md">Phone</th>
                        <th data-breakpoints="md">City</th>
    ...
    <!--                    <td>
                        ...
                        @endif
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('ordervisite.show', encrypt($order->id))}}" title="{{ translate('View') }}">
                                <i class="las la-eye"></i>
                            </a>
                            <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{ route('invoice-visitor.download', $order->id) }}" title="{{ translate('Download Invoice') }}">
                                <i class="las la-download"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('ordervisite.destroy', $order->id)}}" title="{{ translate('Delete') }}">
...
//        }
        ...
        function bulk_delete() {
            ...
            $.ajax({
                ...
                url: "{{route('bulk-order-delete-visitor')}}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
