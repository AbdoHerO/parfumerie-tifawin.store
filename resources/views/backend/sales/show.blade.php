                    ...
                    <div class="col-md-3 ml-auto">
                        ...
                        @if (auth()->user()->can('update_order_delivery_status') && $delivery_status != 'delivered' && $delivery_status != 'cancelled')
                            <select class="form-control aiz-selectpicker" data-minimum-results-for-search="Infinity"
                                ...
                                <option value="no_response" @if ($delivery_status == 'no_response') selected @endif>
                                    <!-- {{ translate('No Response') }} -->
                                    Pas de réponse
                                </option>
                                <option value="boite_vocal" @if ($delivery_status == 'boite_vocal') selected @endif>
                                    <!-- {{ translate('Boite Vocal') }} -->
                                    Boite Vocal
                                </option>
                            </select>
                        @else
