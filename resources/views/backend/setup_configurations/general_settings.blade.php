...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h1 class="mb-0 h6">Google Sheet DB</h1>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.updateSheetDB') }}" method="POST">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">API SheetDB</label>
                            <div class="col-sm-9">
                                <input type="text" name="api_sheet_db" class="form-control" value="{{ get_setting('sheet_db') ? get_setting('sheet_db')  : '' }}">
                            </div>
                        </div>
                        <div class="text-right">
    						<button type="submit" class="btn btn-primary">{{ translate('Update') }}</button>
