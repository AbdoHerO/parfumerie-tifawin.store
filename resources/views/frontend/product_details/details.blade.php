...
<div class="text-left">
    ...
    <div class="d-flex flex-wrap align-items-center mb-3">
        ...
        <a href="{{ route('shop.visit', $detailedProduct->brand->slug) }}" class="text-reset hov-text-primary fs-14 fw-700">{{ $detailedProduct->brand->name }}</a>
    </div>
    @endif
    ...
    <div class="d-flex flex-wrap align-items-center">
        ...
        <div class="">
            <button class="btn btn-sm btn-soft-warning btn-outline-warning hov-svg-white hov-text-white rounded-4" onclick="show_chat_modal()">
            ...
            <div class="col-sm-10">
                <div class="aiz-radio-inline">
                    ...
                    <label class="aiz-megabox pl-0 mr-2 mb-0">
                        <input class="varianteRadio" type="radio" name="attribute_id_{{ $choice->attribute_id }}" value="{{ $value }}" @if($key==0) checked @endif>
            ...
            <div class="col-sm-10">
                <div class="aiz-radio-inline">
                    ...
                    <label class="aiz-megabox pl-0 mr-2 mb-0" data-toggle="tooltip" data-title="{{ \App\Models\Color::where('code', $color)->first()->name }}">
                        <input class="varianteRadio" type="radio" name="color" value="{{ \App\Models\Color::where('code', $color)->first()->name }}" @if($key==0) checked @endif>
            ...
            <div class="col-sm-10">
                <div class="product-quantity d-flex align-items-center">
                    <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                        ...
                        <input type="number" name="quantity" id="inputQuantite" onchange="updateValueQtyforGuest(this.value)" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="10" lang="en">
    ...
    <div class="mt-3 d-flex flex-row justify-content-start">
        ...
        @else
        <button type="button" class="btn btn-primary buy-now fw-600" style="margin-bottom: 10px;margin-right: 10px;" onclick="orderVisite()">
            <i class="la la-shopping-cart"></i> {{ translate('Buy Now')}}
        </button>
        <a class="btn btn-primary whatsapp-order buy-now fw-600 " href="" style="display: flex;justify-content: center;align-items: center; flex-direction: inherit;margin-bottom: 10px;" id="orderByWtp_link">
            <input type="hidden" value="{{ $detailedProduct->id }}" id="id_product_wtp">
            <input type="hidden" value="{{ $detailedProduct->getTranslation('name') }}}" id="name_product_wtp">
            <input type="hidden" value="{{ home_discounted_price($detailedProduct) }}" id="price_product_wtp">

            <i class="la la-whatsapp " style="font-size: 30px;"></i> Commandez par Whatsapp
        </a>
    ...
    <div class="d-table width-100 mt-3">
        <div class="d-table-cell">
            ...
            @endphp
            <div>
                <button type="button" id="ref-cpurl-btn" class="btn btn-secondary w-200px rounded-0" data-attrcpy="{{ translate('Copied') }}" onclick="CopyToClipboard(this)" data-url="{{ $referral_code_url }}">{{ translate('Copy the Promote Link') }}</button>
            </div>
            @endif
        </div>
    </div>
