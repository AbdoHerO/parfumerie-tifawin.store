...
@section('panel_content')
    ...
    <form action="{{ route('seller.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <label class="col-md-3 col-form-label" for="bank">{{ translate('Bank Name') }}</label>
                    <div class="col-md-9">
                        <input type="text" name="bank" value="{{ $user->bank }}" id="bank" class="form-control mb-3" placeholder="{{ translate('Bank Name')}}">
                        @error('phone')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <label class="col-md-3 col-form-label" for="rib">{{ translate('Bank Account Number') }} (RIB)</label>
                    <div class="col-md-9">
                        <input type="text" name="rib" value="{{ $user->rib }}" id="rib" class="form-control mb-3" placeholder="{{ translate('Bank Account Number')}} (RIB)">
                        @error('rib')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
