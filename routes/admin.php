...
use App\Http\Controllers\OrdervisitController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // -----------------------------------------------------------------------
    // Order visit 
    Route::controller(OrdervisitController::class)->group(function () {
        // all_order_visitor
    	Route::get('/all_orders_visitor', 'index')->name('ordervisite.index');
    	Route::get('/all_orders_visitor{id}/show', 'all_orders_show')->name('ordervisite.show');
    	Route::post('/bulk-order-delete-visitor', 'bulk_order_delete')->name('bulk-order-delete-visitor');
    	
        Route::post('/orders_visitor/update_delivery_status', 'update_delivery_status')->name('orders_visitor.update_delivery_status');
        Route::post('/orders_visitor/update_payment_status', 'update_payment_status')->name('orders_visitor.update_payment_status');
        Route::post('/orders_visitor/update_tracking_code', 'update_tracking_code')->name('orders_visitor.update_tracking_code');
    ...
    Route::controller(EventController::class)->group(function () {
        // all_order_visitor
    	Route::get('/all_event_products', 'get_events_products')->name('events.get_events_products');
    	Route::get('/all_event_orders', 'get_events_orders')->name('events.get_events_orders');
    });
    // -----------------------------------------------------------------------
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        Route::post('/business-settings/updateSheetDB', 'updateSheetDB')->name('business_settings.updateSheetDB');
