...
Route::controller(OrdervisitController::class)->group(function () {
    Route::post('/ordervisite', 'store')->name('ordervisite.store');
    Route::get('/ordervisite/destroy/{id}', 'destroy')->name('ordervisite.destroy');
});


//imprimer pdf ordervisitr
Route::controller(InvoiceController::class)->group(function () {
    Route::get('invoice-visitor/{order_id}', 'invoice_download_visitor')->name('invoice-visitor.download');
});
